  ...
  <div class="col-lg-12">
    <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
      ...
      <div class="card-header text-white d-flex justify-content-between align-items-center"
        style="background: linear-gradient(90deg, #4e54c8, #8f94fb); padding: 1.5rem;">
        ...
        <a href="{{ route('models.index') }}" class="btn btn-light fw-semibold shadow-sm">
              ...
              @forelse($products as $product)
                <tr style="height: 55px; background-color: {{ $loop->even ? '#f9f9f9' : '#ffffff' }};">
                  ...
                  <td title="{{ $product->category->category_name ?? '-' }}">
                    {{ Str::limit($product->category->category_name ?? '-', 8) }}
                  </td>
