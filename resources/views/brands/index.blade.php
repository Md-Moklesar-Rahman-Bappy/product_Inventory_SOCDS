              ...
              <tr class="bg-white" style="height: 55px;">
                ...
                <td>
                    <div class="d-flex justify-content-center flex-wrap gap-2">
                        {{-- View Details --}}
                        <a href="{{ route('brands.show', $brand->id) }}" class="btn btn-sm btn-outline-info shadow-sm" title="View">
                        <i class="fa fa-eye"></i>
                        </a>

                        {{-- Edit Brand --}}
                        <a href="{{ route('brands.edit', $brand->id) }}" class="btn btn-sm btn-outline-warning shadow-sm" title="Edit Brand">
                        <i class="fa fa-edit"></i>
                        </a>

                        {{-- View Products --}}
                        <a href="{{ route('brands.products', $brand->id) }}" class="btn btn-sm btn-outline-success shadow-sm" title="View Products">
                        ...
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-sm btn-outline-danger shadow-sm" title="Delete Brand">
