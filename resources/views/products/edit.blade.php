      ...
      <form action="{{ route('products.update', $product->id) }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                value="{{ old('warranty_start', $product->warranty_start ? \Carbon\Carbon::parse($product->warranty_start)->format('Y-m-d') : '') }}">
            ...
            <div class="col-md-6">
                ...
                value="{{ old('warranty_end', $product->warranty_end ? \Carbon\Carbon::parse($product->warranty_end)->format('Y-m-d') : '') }}">
